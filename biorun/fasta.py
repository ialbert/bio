...
@plac.flg("translate", "translate DNA sequences", abbrev='T')
@plac.opt("alias", "remap sequence ids")
@plac.pos("fnames", "input files")
def run(protein=False, translate=False, start='1', end='', type_='', id_='', name='', gene='', alias=None, *fnames):

    convert.run(protein=protein, translate=translate, start=start, end=end, type_=type_, id_=id_,
