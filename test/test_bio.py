...
def test_14(capsys):
    run("bio align GATTACA GATCA --vcf > gattaca.vcf")

def test_15(capsys):
    run("bio align align_input.fa --vcf > align_input.vcf")
...
def test_18(capsys):
    run("bio align s.fa --table > align-s.txt")

def test_19(capsys):
    run("bio align s.fa --vcf > align-ss.vcf")
