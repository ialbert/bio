'''
This library contains code for Plac:

The library also contains an improvement we made that has not yet made it into the main PyPI release.

https://github.com/micheles/plac/pull/51

Since the library is so simple it was easier to include it here than keep asking the author to make a new release.
